...
/* ═══════════════════════════════════════════════════════════════
   VISTA AUXILIAR - PANEL DE GESTIÓN
   ═══════════════════════════════════════════════════════════════ */

function AuxiliarLiberacionView() {
    ...
    <div className="h-screen bg-background overflow-y-auto">
      <main className="max-w-6xl mx-auto px-4 pt-6 sm:pt-8 pb-32">
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange}>
          ...
          {/* Tab content (all share the same render) */}
          {['todos', 'pendiente', 'confirmado', 'en_examen', 'finalizado'].map((tabVal) => (
                  ...
                  <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <p className="text-sm text-muted-foreground/70 mt-1">
                      {tabVal === 'todos'
                        ...
                        : `No hay estudiantes con estado "${tabVal.replace('_', ' ')}".`
                      }
                    </p>
                  </CardContent>
                </Card>
